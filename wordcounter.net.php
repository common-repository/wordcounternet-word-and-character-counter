<?php
/*
Plugin Name: WordCounter.net
Plugin URI: http://www.wordcounter.net
Description: Counts words and characters in posts
Version: 1.01
Author: Nate Sanden
Author URI: http://www.wordcounter.net
*/
...
jQuery(document).ready(function($) {
    ...
    "<td style='padding: 2px 10px' id='wordcounternet'><a href='http://www.wordcounter.net'>WordCounter.net</a> Words: <span id='words'>0</span> Characters: <span id='characters'>0</span></td>"
    );
